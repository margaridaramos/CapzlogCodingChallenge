...
using codingChallengeCapzlog;
using Newtonsoft.Json;
using Newtonsoft.Json.Linq;

namespace codingChallengeCapzlog.Tests
{
    public class Tests
    {
        [SetUp]
        ...
        {
            string expectedMessage = "Usage: codingChallengeCapzlog <path_to_pdf>";

            string output = Program.ProcessFile(new string[] { });
        ...
        public void Main_Method_Shows_Expected_Output_When_Test_File_Is_Provided()
        {
            ...
            // Act
            string result = Program.ProcessFile(new string[] { pdfFilePath });
